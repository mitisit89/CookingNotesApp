...
def create():
    ...
    return render_template('create_post_and_edit.html', title='Создать запись', form=form)
...
def edit(slug):
    ...
    if request.method == 'POST':
        ...
        return render_template('create_post_and_edit.html', title='Редактировать запись', form=form, post=post_for_edit)
